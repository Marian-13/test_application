class PhotosController < ApplicationController
  ...
  def index
    if @tag.valid?
      ...
      # TODO Cannot fetch tag/task;: queried too recently - APICache::CannotFetch
      ...
      @photos =
        ...
        # ApplicationController::CacheApiRequest.new(api_request, options).call(unique_key, cache: 15)
